...
function! layers#lang#latex#plugins() abort
  let plugins = [
        \ ['zhujinxuan/snippets-tex-equations', {'on_ft': 'tex', 'for': 'tex'}]
        \ ]
  if !g:is_spacevim
    let plugins += [
          \ ['lervag/vimtex', {'merged' : 0}],
          \ ]
  endif
  return plugins
endfunction

function! layers#lang#latex#config() abort
